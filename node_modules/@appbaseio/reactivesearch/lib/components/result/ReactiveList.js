...
var ReactiveList = function (_Component) {
	...
	ReactiveList.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			this.props.onAllData ? this.props.onAllData(results, streamResults, this.loadMore, { base: currentPage * size, triggerClickAnalytics: this.triggerClickAnalytics }) : _react2.default.createElement(
				'div',
